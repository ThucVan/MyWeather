package com.example.myweather.util.flow

import com.example.myweather.util.exception.AppException
import com.example.myweather.util.exception.ServerException
